...
class Ligue extends StatefulWidget {
  const Ligue({Key? key}) : super(key: key);

  @override
  State<Ligue> createState() => _LigueState();
}

class _LigueState extends State<Ligue> {
  var i;
  @override
  ...
  Widget BuildCarousel(FixtureModel? model)=>Scaffold(
    appBar: AppBar(
      ...
      title: Padding(
        ...
        child: Text("Ligue 1",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900),),
      ),
    ),

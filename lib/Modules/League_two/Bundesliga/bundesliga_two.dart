...
class BundesligaTwo extends StatefulWidget {
  const BundesligaTwo({Key? key}) : super(key: key);

  @override
  State<BundesligaTwo> createState() => _BundesligaTwoState();
}

class _BundesligaTwoState extends State<BundesligaTwo> {
  @override
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 90,),
                      Text("Bundesliga ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900),)
                    ],
                  ),
                ),
                SizedBox(height:15),

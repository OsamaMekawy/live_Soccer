...
class PremierLeagueTwo extends StatefulWidget {
  const PremierLeagueTwo({Key? key}) : super(key: key);

  @override
  State<PremierLeagueTwo> createState() => _PremierLeagueTwoState();
}

class _PremierLeagueTwoState extends State<PremierLeagueTwo> {
  @override
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 90,),
                    Text("Premier League",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900),)
                  ],
                ),
              ),
              SizedBox(height:15),

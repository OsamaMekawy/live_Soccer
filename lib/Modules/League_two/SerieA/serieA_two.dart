...
class SerieATwo extends StatefulWidget {
  const SerieATwo({Key? key}) : super(key: key);

  @override
  State<SerieATwo> createState() => _SerieATwoState();
}

class _SerieATwoState extends State<SerieATwo> {
  @override
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 90,),
                      Text("Serie A",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900),)
                    ],
                  ),
                ),
                SizedBox(height:15),

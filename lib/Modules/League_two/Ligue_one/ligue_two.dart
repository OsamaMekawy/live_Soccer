...
class ligueTwo extends StatefulWidget {
  const ligueTwo({Key? key}) : super(key: key);

  @override
  State<ligueTwo> createState() => _ligueTwoState();
}

class _ligueTwoState extends State<ligueTwo> {
  @override
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 90,),
                      Text("Ligue 1",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900),)
                    ],
                  ),
                ),
                SizedBox(height:15),
